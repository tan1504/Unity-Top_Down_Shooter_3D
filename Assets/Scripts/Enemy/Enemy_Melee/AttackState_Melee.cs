...
public class AttackState_Melee : EnemyState
{
	...
	public override void Enter()
	{
		...
		attackModeSpeed = enemy.attackData.moveSpeed;
	...
	public override void Update()
	{
		...
		if (enemy.ManualMovementActive())
		{
			enemy.transform.position =
				Vector3.MoveTowards(enemy.transform.position, attackDirection, attackModeSpeed * Time.deltaTime);
		}
	...
	private AttackData_EnemyMelee UpdatedAttackData()
	{
		...
		if (PlayerClose())
			validAttacks.RemoveAll(paramater => paramater.attackType == AttackType_Melee.Charge);
