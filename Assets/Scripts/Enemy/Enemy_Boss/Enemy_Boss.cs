...
public class Enemy_Boss : Enemy
{
	...
	private float lastTimeJumpAttack;
	...
	[Space]
	[SerializeField] private LayerMask whatToIngnore;
	...
	protected override void Awake()
	{
		...
		deadState = new DeadState_Boss(this, stateMachine, "Idle");		// idle is just a place holder, we use ragdoll
	}
	...
	public bool CanJumpAttack()
	{
		...
		if (Time.time > lastTimeJumpAttack + jumpAttackCooldown && IsPlayerInClearSight())
		{
			return true;
		}
	...
	public void SetJumpAttackOnCooldown() => jumpAttackCooldown = Time.time;
	...
	public bool IsPlayerInClearSight() 
	{
        ...
        if (Physics.Raycast(myPos, directionToPlayer, out RaycastHit hit, 100, ~whatToIngnore))
        {
